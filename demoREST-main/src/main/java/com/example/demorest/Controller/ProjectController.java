...
import com.example.demorest.DAO.DAOImplementation.OrganizationHRDAOImpl;
import com.example.demorest.DAO.Organization_HRDAO;
...
public class ProjectController {
    Organization_HRDAO pDAO = new OrganizationHRDAOImpl();
